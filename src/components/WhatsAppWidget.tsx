...
const WhatsAppWidget = (): React.JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-gradient-to-r from-teal-500 to-green-500 text-white p-4 rounded-t-xl flex justify-between items-center text-start">
          <div>
        ...
        <div className="p-4 h-48 flex flex-col text-start">
        ...
        <div className="p-3 border-t flex items-center gap-2">
          <textarea
            ...
            className="flex-grow bg-gray-100 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400 resize-none h-10 text-start"
          />
          <button 
